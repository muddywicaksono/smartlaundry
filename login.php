...
<body>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: #c5acd8">
            ...
            <div class="modal-body">
               ...
               <form method="POST" action="ceklogin.php">
							...
							if(isset($_GET['pesan'])){
								...
								if($pesan == "gagal"){ ?>
									<div class="alert alert-danger alert-dismissible fade show" role="alert">
  											Fail to Login! Inccorect Username or Password
					...
					<center><br><input class="btn btn-light	" type="submit" value="LOGIN"></center>
					<br>
					<center>
						<p class="col">
							Don't have an account? Sign Up
							<a href="form_register.php"><font color="#f3eef7">here</font>	</a>
						</p>
					</center>
				</form>
